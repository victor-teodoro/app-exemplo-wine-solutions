...
public class processingPinpad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_processing_pinpad);
    ...
    public void goMpos(String dev) throws IOException {
        ...
        final Intent success = new Intent(this, successNormal.class);
