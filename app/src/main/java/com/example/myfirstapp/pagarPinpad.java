...
public class pagarPinpad extends AppCompatActivity {

    private static final String TAG = pagarPinpad.class.getName();
    public static String dev;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pagar_pinpad);
        // initiate a ListView
    ...
    public void callPinpad(View view){
        ...
        Intent intent = new Intent(this, processingPinpad.class);
